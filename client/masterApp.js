...
// Profile controller
masterApp.controller('profileController', function($window, $event, $scope, $http, $resource, $location, $routeParams, authenticateUser, userFactory, multipartForm, $timeout){
