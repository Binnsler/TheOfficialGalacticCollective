...
var userSchema = mongoose.Schema({
  ...
  profileName : {type: String, default: 'Nobody No-one'},
  profileLocation : {type: String, default: 'Nowheresville, NW'},
  profileBlurb : {type: String, default: 'A quick 160 character blurb about myself, which I was far too lazy to make unique.' },
  ...
  skills : {type: String, default: 'I have no skills whatsoever. On second thought: sleeping, not working, being unmotivated.'},
  profileBio : {type: String, default: 'Once again, I am far too lazy to complete my profile.'},
